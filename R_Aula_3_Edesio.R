...
# FUNCIONAL E OO | prof. Neylson Crepalde| Aula 3
# por Edésio Rocha Jr.
#################################################
...
# 2) Soma da raíz quadrada do primeiro com o segundo elevado ao cubo.

sqrt(a) + b^3

# 3) Crie um banco de dados com os nomes de todos os animais de estimação que você já teve.
# Obs.: Você já teve pelo menos 5 animais de 3 espécies diferentes! 
# No seu banco de dados deverá haver nome, idade, espécie, alimentação/semana (kg) -> numeric
...
# Subsetting na lista | só é possivel fazer com [ ]
...
# Dentro da lista, faça um subsetting do elemento que está na linha 4, coluna 2 da matriz

lista[[3]][4, 2]

# Dentro da lista, obtenha o elemento que está na 3 linha na coluna 2 do data frame
...
# EXTRAINDO AS CLASSES DE UMA LISTA
  # lista
